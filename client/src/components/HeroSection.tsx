...
import heroImage from '@assets/generated_images/Professional_headshot_portrait_744cdc64.png';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 lg:space-y-8">
            ...
            <p className="text-base lg:text-lg text-foreground/90 max-w-xl" data-testid="text-intro">
          ...
          <div className="relative">
            <div className="relative z-10">
              <img
                src={heroImage}
                alt="Niranjan Kollipara"
                className="w-full max-w-md mx-auto rounded-lg shadow-xl"
                data-testid="img-hero"
              />
            </div>
            <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-chart-2/20 rounded-lg blur-2xl -z-10" />
          </div>
        </div>
      </div>
    </section>
